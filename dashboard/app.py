        ...
        with tabs[3]:
            ...
            for product, name in products_config.items():
                if product in available_products:
                    ...
                    st.image(f"dashboard/graphs/{name}_Forecast{training_weeks}.png", width="stretch")

                    st.markdown("### Model Performance")
                    col1, col2 = st.columns(2)
                    col1.image(f"dashboard/graphs/{name}_Performance{training_weeks}.png", width="stretch")
                    col2.image(f"dashboard/graphs/{name}_Heatmap{training_weeks}.png", width="stretch")
